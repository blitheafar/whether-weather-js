(function(){
  ...
  // -------------------------------------------------
  	...
  	// Variables
		...
		$(".wf-menu-dark ul>li>.dmui_dropdown_block a.close").click(function() {
		   $(this).closest("li").removeClass("hovered");
		   //console.log("Removed");
		   //$(this).closest("li.dmui_dropdown_block").unbind('hover');
		   
		});
		$(".wf-menu-dark ul>li>.dmui_dropdown_block input").click(function() {
		  // console.log("Added");
